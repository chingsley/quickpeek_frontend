...
export const colors = {
  ...
  HOME_HEADER_COLLAPSED_TINT: 'rgba(255, 255, 255, 1)',
  /** Fully clear starting point for the header strip's tint fade (same white as the tint at 0 alpha). */
  HOME_HEADER_STRIP_CLEAR: 'rgba(255, 255, 255, 0)',
